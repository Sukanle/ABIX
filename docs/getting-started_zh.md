...
* [`abix_zh.md`](abix_zh.md) — `.abix` artifact 格式
* [`compatibility_zh.md`](compatibility_zh.md) — ABI 身份与兼容性
* [`amc_zh.md`](amc_zh.md) — AMC 工具链
* [`architecture_zh.md`](architecture_zh.md) — 整体架构
