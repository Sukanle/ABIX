...
自举闭环。artifact 格式本身见 [`abix_zh.md`](abix_zh.md)；运行时 API 见
[`runtime_zh.md`](runtime_zh.md)。
...
[`compatibility_zh.md`](compatibility_zh.md)。
...
和 Symbol Table section。权威描述见 [`abix_zh.md`](abix_zh.md)。
