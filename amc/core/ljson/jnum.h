...
#else
static inline jnum_to_func(int32_t, jnum_atoi) static inline jnum_to_func(
    int64_t, jnum_atol) static inline jnum_to_func(uint32_t, jnum_atoh) static inline jnum_to_func(uint64_t,
    jnum_atolh) static inline jnum_to_func(double, jnum_atod)
#endif
