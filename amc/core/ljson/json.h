 ...
 * @param   list the list value, LJSON associates `list` to the `head` of parent json object or the `list` of brother
 * json objects
...
static inline json_object *json_create_binary_array(json_binary_t *values, int count) {
    return json_create_item_array(JSON_BINARY, values, count);
}

#ifdef __cplusplus
}
static inline json_object *json_create_units(bool *values, int count) {
    return json_create_item_array(JSON_BOOL, values, count);
}
static inline json_object *json_create_units(int32_t *values, int count) {
    return json_create_item_array(JSON_INT, values, count);
}
static inline json_object *json_create_units(uint32_t *values, int count) {
    return json_create_item_array(JSON_HEX, values, count);
}
static inline json_object *json_create_units(int64_t *values, int count) {
    return json_create_item_array(JSON_LINT, values, count);
}
static inline json_object *json_create_units(uint64_t *values, int count) {
    return json_create_item_array(JSON_LHEX, values, count);
}
static inline json_object *json_create_units(double *values, int count) {
    return json_create_item_array(JSON_DOUBLE, values, count);
}
static inline json_object *json_create_units(json_string_t *values, int count) {
    return json_create_item_array(JSON_STRING, values, count);
}
static inline json_object *json_create_units(json_binary_t *values, int count) {
    return json_create_item_array(JSON_BINARY, values, count);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define json_create_units(values, count)           \
      _Generic((values),                             \
...
static inline void json_string_info_update(json_string_t *jstr) {
    if (!jstr->info.len) jstr->info = json_string_info_get(jstr->str, &jstr->info);
}
...
static inline int json_set_number(json_object *json, bool value) {
    return json_set_number_value(json, JSON_BOOL, &value);
}
static inline int json_set_number(json_object *json, int32_t value) {
    return json_set_number_value(json, JSON_INT, &value);
}
static inline int json_set_number(json_object *json, uint32_t value) {
    return json_set_number_value(json, JSON_HEX, &value);
}
static inline int json_set_number(json_object *json, int64_t value) {
    return json_set_number_value(json, JSON_LINT, &value);
}
static inline int json_set_number(json_object *json, uint64_t value) {
    return json_set_number_value(json, JSON_LHEX, &value);
}
static inline int json_set_number(json_object *json, double value) {
    return json_set_number_value(json, JSON_DOUBLE, &value);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define json_set_number(json, value)   \
      _Generic((value),                  \
...
static inline json_object *json_add_binary_to_array(json_object *array, json_binary_t *value) {
    return json_add_new_item_to_array(array, JSON_BINARY, value);
}
...
static inline json_object *json_array_append(json_object *array, bool value) {
    return json_add_new_item_to_array(array, JSON_BOOL, &value);
}
static inline json_object *json_array_append(json_object *array, int32_t value) {
    return json_add_new_item_to_array(array, JSON_INT, &value);
}
static inline json_object *json_array_append(json_object *array, uint32_t value) {
    return json_add_new_item_to_array(array, JSON_HEX, &value);
}
static inline json_object *json_array_append(json_object *array, int64_t value) {
    return json_add_new_item_to_array(array, JSON_LINT, &value);
}
static inline json_object *json_array_append(json_object *array, uint64_t value) {
    return json_add_new_item_to_array(array, JSON_LHEX, &value);
}
static inline json_object *json_array_append(json_object *array, double value) {
    return json_add_new_item_to_array(array, JSON_DOUBLE, &value);
}
static inline json_object *json_array_append(json_object *array, json_string_t *value) {
    return json_add_new_item_to_array(array, JSON_STRING, value);
}
static inline json_object *json_array_append(json_object *array, json_binary_t *value) {
    return json_add_new_item_to_array(array, JSON_BINARY, value);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define json_array_append(array, value)            \
      _Generic((value),                              \
...
static inline json_object *json_add_binary_to_object(json_object *object, json_string_t *jkey, json_binary_t *value) {
    return json_add_new_item_to_object(object, JSON_BINARY, jkey, value);
}
...
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, bool value) {
    return json_add_new_item_to_object(object, JSON_BOOL, jkey, &value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, int32_t value) {
    return json_add_new_item_to_object(object, JSON_INT, jkey, &value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, uint32_t value) {
    return json_add_new_item_to_object(object, JSON_HEX, jkey, &value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, int64_t value) {
    return json_add_new_item_to_object(object, JSON_LINT, jkey, &value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, uint64_t value) {
    return json_add_new_item_to_object(object, JSON_LHEX, jkey, &value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, double value) {
    return json_add_new_item_to_object(object, JSON_DOUBLE, jkey, &value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, json_string_t *value) {
    return json_add_new_item_to_object(object, JSON_STRING, jkey, value);
}
static inline json_object *json_object_append(json_object *object, json_string_t *jkey, json_binary_t *value) {
    return json_add_new_item_to_object(object, JSON_BINARY, jkey, value);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define json_object_append(object, jkey, value)     \
      _Generic((value),                               \
...
static inline json_object *pjson_create_binary(json_binary_t *value, json_mem_t *mem) {
    return pjson_create_item(JSON_BINARY, value, mem);
}
...
static inline json_object *pjson_create_unit(bool value, json_mem_t *mem) {
    return pjson_create_item(JSON_BOOL, &value, mem);
}
static inline json_object *pjson_create_unit(int32_t value, json_mem_t *mem) {
    return pjson_create_item(JSON_INT, &value, mem);
}
static inline json_object *pjson_create_unit(uint32_t value, json_mem_t *mem) {
    return pjson_create_item(JSON_HEX, &value, mem);
}
static inline json_object *pjson_create_unit(int64_t value, json_mem_t *mem) {
    return pjson_create_item(JSON_LINT, &value, mem);
}
static inline json_object *pjson_create_unit(uint64_t value, json_mem_t *mem) {
    return pjson_create_item(JSON_LHEX, &value, mem);
}
static inline json_object *pjson_create_unit(double value, json_mem_t *mem) {
    return pjson_create_item(JSON_DOUBLE, &value, mem);
}
static inline json_object *pjson_create_unit(json_string_t *value, json_mem_t *mem) {
    return pjson_create_item(JSON_STRING, value, mem);
}
static inline json_object *pjson_create_unit(json_binary_t *value, json_mem_t *mem) {
    return pjson_create_item(JSON_BINARY, value, mem);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define pjson_create_unit(value, mem)         \
      _Generic((value),                         \
...
static inline json_object *pjson_create_binary_array(json_binary_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_BINARY, values, count, mem);
}

#ifdef __cplusplus
}
static inline json_object *pjson_create_units(bool *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_BOOL, values, count, mem);
}
static inline json_object *pjson_create_units(int32_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_INT, values, count, mem);
}
static inline json_object *pjson_create_units(uint32_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_HEX, values, count, mem);
}
static inline json_object *pjson_create_units(int64_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_LINT, values, count, mem);
}
static inline json_object *pjson_create_units(uint64_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_LHEX, values, count, mem);
}
static inline json_object *pjson_create_units(double *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_DOUBLE, values, count, mem);
}
static inline json_object *pjson_create_units(json_string_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_STRING, values, count, mem);
}
static inline json_object *pjson_create_units(json_binary_t *values, int count, json_mem_t *mem) {
    return pjson_create_item_array(JSON_BINARY, values, count, mem);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define pjson_create_units(values, count, mem)      \
      _Generic((values),                              \
...
static inline json_object *pjson_add_binary_to_array(json_object *array, json_binary_t *value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_BINARY, value, mem);
}
...
static inline json_object *pjson_array_append(json_object *array, bool value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_BOOL, &value, mem);
}
static inline json_object *pjson_array_append(json_object *array, int32_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_INT, &value, mem);
}
static inline json_object *pjson_array_append(json_object *array, uint32_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_HEX, &value, mem);
}
static inline json_object *pjson_array_append(json_object *array, int64_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_LINT, &value, mem);
}
static inline json_object *pjson_array_append(json_object *array, uint64_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_LHEX, &value, mem);
}
static inline json_object *pjson_array_append(json_object *array, double value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_DOUBLE, &value, mem);
}
static inline json_object *pjson_array_append(json_object *array, json_string_t *value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_STRING, value, mem);
}
static inline json_object *pjson_array_append(json_object *array, json_binary_t *value, json_mem_t *mem) {
    return pjson_add_new_item_to_array(array, JSON_BINARY, value, mem);
}
extern "C" {
#else
/* C11泛型选择(Generic selection) */
#  define pjson_array_append(array, value, mem)       \
      _Generic((value),                               \
 ...
 * @note    指针指向创建的json对象
 */
json_object *pjson_add_new_item_to_object(
    json_object *object, json_type_t type, json_string_t *jkey, void *value, json_mem_t *mem);
...
static inline json_object *pjson_add_bool_to_object(
    json_object *object, json_string_t *jkey, bool value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_BOOL, jkey, &value, mem);
}
static inline json_object *pjson_add_int_to_object(
    json_object *object, json_string_t *jkey, int32_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_INT, jkey, &value, mem);
}
static inline json_object *pjson_add_hex_to_object(
    json_object *object, json_string_t *jkey, uint32_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_HEX, jkey, &value, mem);
}
static inline json_object *pjson_add_lint_to_object(
    json_object *object, json_string_t *jkey, int64_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_LINT, jkey, &value, mem);
}
static inline json_object *pjson_add_lhex_to_object(
    json_object *object, json_string_t *jkey, uint64_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_LHEX, jkey, &value, mem);
}
static inline json_object *pjson_add_double_to_object(
    json_object *object, json_string_t *jkey, double value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_DOUBLE, jkey, &value, mem);
}
static inline json_object *pjson_add_string_to_object(
    json_object *object, json_string_t *jkey, json_string_t *value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_STRING, jkey, value, mem);
}
static inline json_object *pjson_add_binary_to_object(
    json_object *object, json_string_t *jkey, json_binary_t *value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_BINARY, jkey, value, mem);
}
...
static inline json_object *pjson_object_append(json_object *object, json_string_t *jkey, bool value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_BOOL, jkey, &value, mem);
}
static inline json_object *pjson_object_append(
    json_object *object, json_string_t *jkey, int32_t value, json_mem_t *mem) {
    return pjson_add_new_item_to_object(object, JSON_INT, jkey, &value, mem);
}
static inline json_object *pjson_object_append(
...
#else
/* C11泛型选择(Generic selection) */
#  define pjson_object_append(object, jkey, value, mem) \
      _Generic((value),                                 \
 ...
 * @param   plus_size [IN] 打印到字符串时重新分配内存时增加的内存大小，或打印到文件时的写入缓冲区大小，默认值为
 * `JSON_PRINT_SIZE_PLUS_DEF`(1024)
 * @param   item_size [IN] 将 JSON 对象转换为字符串时的大小，默认值为 `JSON_FORMAT_ITEM_SIZE_DEF`(32)（当 format_flag 为
 * true 时）或 `JSON_UNFORMAT_ITEM_SIZE_DEF`(24)（当 format_flag 为 false 时）
...
static inline char *json_print_format(json_object *json, int item_total, size_t *length, json_print_ptr_t *ptr) {
    ...
    if (length) *length = choice.str_len;
    return str;
}
 ...
 * @param   mem_size the default block memory size to allocate, its smallest value is (str_len /
 * `JSON_STR_MULTIPLE_NUM`(8))
 ...
 * @return  失败返回NULL；成功返回指针（SAX打印器的句柄）
 */
static inline json_sax_print_hd json_sax_fprint_unformat_start(
    int item_total, const char *path, json_print_ptr_t *ptr) {
    json_print_choice_t choice;
...
static inline int json_sax_print_binary(json_sax_print_hd handle, json_string_t *jkey, json_binary_t *value) {
    return json_sax_print_value(handle, JSON_BINARY, jkey, value);
}
...
static inline int json_sax_print_array_item(json_sax_print_hd handle, bool value) {
    return json_sax_print_value(handle, JSON_BOOL, NULL, &value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, int32_t value) {
    return json_sax_print_value(handle, JSON_INT, NULL, &value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, uint32_t value) {
    return json_sax_print_value(handle, JSON_HEX, NULL, &value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, int64_t value) {
    return json_sax_print_value(handle, JSON_LINT, NULL, &value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, uint64_t value) {
    return json_sax_print_value(handle, JSON_LHEX, NULL, &value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, double value) {
    return json_sax_print_value(handle, JSON_DOUBLE, NULL, &value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, json_string_t *value) {
    return json_sax_print_value(handle, JSON_STRING, NULL, value);
}
static inline int json_sax_print_array_item(json_sax_print_hd handle, json_binary_t *value) {
    return json_sax_print_value(handle, JSON_BINARY, NULL, value);
}
extern "C" {
#  else
/* C11泛型选择(Generic selection) */
#    define json_sax_print_array_item(handle, value) \
        _Generic((value),                            \
...
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, bool value) {
    return json_sax_print_value(handle, JSON_BOOL, jkey, &value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, int32_t value) {
    return json_sax_print_value(handle, JSON_INT, jkey, &value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, uint32_t value) {
    return json_sax_print_value(handle, JSON_HEX, jkey, &value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, int64_t value) {
    return json_sax_print_value(handle, JSON_LINT, jkey, &value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, uint64_t value) {
    return json_sax_print_value(handle, JSON_LHEX, jkey, &value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, double value) {
    return json_sax_print_value(handle, JSON_DOUBLE, jkey, &value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, json_string_t *value) {
    return json_sax_print_value(handle, JSON_STRING, jkey, value);
}
static inline int json_sax_print_object_item(json_sax_print_hd handle, json_string_t *jkey, json_binary_t *value) {
    return json_sax_print_value(handle, JSON_BINARY, jkey, value);
}
extern "C" {
#  else
/* C11泛型选择(Generic selection) */
#    define json_sax_print_object_item(handle, jkey, value) \
        _Generic((value),                                   \
            bool: json_sax_print_bool,                      \
            int32_t: json_sax_print_int,                    \
            uint32_t: json_sax_print_hex,                   \
 ...
 * @note    当打印到文件时，成功时返回 "ok"，不要释放它；当打印到字符串时，返回打印的字符串，使用 `json_memory_free`
 * 释放它或ptr->p
 */
