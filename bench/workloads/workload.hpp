...
// ============================================================
// Operation — atomic unit of work in a benchmark iteration
// ============================================================
...
// ============================================================
// WorkloadSchedule — deterministic operation sequence
//
// Non-owning view into a pre-generated operation array.
// The array is owned by a static storage inside generate_schedule().
// ============================================================
...
// ============================================================
// WorkloadProfile — configurable workload parameters
//
// reader_percent + retire_percent + sync_percent = 100
// ============================================================
struct WorkloadProfile {
    ...
    uint32_t    operations_per_iteration = 100; // schedule length
...
// ============================================================
// WorkloadConfig — complete configuration for a benchmark run
// ============================================================
